...
#'
#' @export make.sim.spec_SingA_TimeOrdL

make.sim.spec_SingA_TimeOrdL <- function(timepoint){
  spec <- list(
    qL.c=c(LA_1='LA_1~L3.1.W1+L5.2.W2+A',LZ_1='LZ_1~L2.2.W1+A+Z_1'),
    qz.c= c(Z_1='Z_1~L3.1.W1+LA_1+A'),
    g.c=c(C_1='C_1~L1.1.W1',A='A~L1.2.W1+L3.1.W1+L2.1.W1'),

    QZ.c=c(Z_1='Q.kplus1~L1.1.W1+L1.2.W1+L2.1.W1+L2.2.W1+L3.1.W1+L5.1.W2+L5.2.W2+L6.W2+A+LA_1'),
    QL.c=c(LA_1='Q.kplus1~L1.1.W1+L1.2.W1+L2.1.W1+L2.2.W1+L3.1.W1+L5.1.W2+L5.2.W2+L6.W2+A',LZ_1='Q.kplus1~L1.1.W1+L1.2.W1+L2.1.W1+L2.2.W1+L3.1.W1+L5.1.W2+L5.2.W2+L6.W2+A+LA_1+Z_1+A:Z_1'),

    qL.m = c(LA_1='LA_1~A',LZ_1='LZ_1~A+Z_1',Y_1='Y_1~A+Z_1'),
    qz.m = c(Z_1='Z_1~A'),
    g.m=c(C_1='C_1~1',A_1='A~1'),
    QZ.m =c(Z_1='Q.kplus1~A1'),
    QL.m =c(LA_1='Q.kplus1~A1',LZ_1='Q.kplus1~A+Z_1'))

  #Still need to edit this part: do it later, not as important. Will not have a specified model for the data anyways
  if(timepoint >1){
